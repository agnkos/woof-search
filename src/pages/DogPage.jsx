...
const DogPage = () => {
    ...
    // - ale gdyby użytkownik wpisał ręcznie w pasku adresu przeglądarki rasę do wyszukiwania - przy braku zdjęcia w bazie setError(true) i wyświetla się komponent NotFound
